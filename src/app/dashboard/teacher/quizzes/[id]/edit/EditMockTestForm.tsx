...
export default function EditMockTestForm({
  initialData,
}: {
  initialData: any
}) {
  ...
  const [isDraftState, setIsDraftState] = useState(
    ...
    <form onSubmit={handleUpdate} className="space-y-8 pb-20">
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="flex items-center gap-2 pt-2">
            <input
              ...
              onChange={(e) =>
                setIsDraftState(e.target.checked)
              }
      ...
      <div className="space-y-4">
        ...
        {questions.map((q, index) => (
          <Card
            key={index}
            className="relative border-l-4 border-l-blue-500 shadow-sm hover:shadow-md"
          >
            <Button
              type="button"
              variant="ghost"
